...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Paket Soal <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
	    <h1></h1>
	    <a href="<%=Config.base_url%>index/PaketSoalTigaButir/input/-1">Tambah Data</a>
          ...
          <tbody>
            <c:forEach items="${row}" var="item" varStatus="status" >
              <tr>
                ...
                <td><a href="<%=Config.base_url%>index/PaketSoalTigaButir/input/${item.idpaket_soal_tiga_butir}">Ubah</a> <a href="<%=Config.base_url%>index/PaketSoalTigaButir/delete/${item.idpaket_soal_tiga_butir}"
