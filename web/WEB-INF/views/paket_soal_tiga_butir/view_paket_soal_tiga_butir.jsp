...
<tbody>
  <c:forEach items="${row}" var="item" varStatus="status" >
    <tr>
      ...
      <td>
         <a href="<%=Config.base_url%>index/PaketSoalTigaButir/input/${item.idpaket_soal_tiga_butir}">Ubah</a>
         <a href="<%=Config.base_url%>index/PaketSoalTigaButir/delete/${item.idpaket_soal_tiga_butir}" onClick="return confirm('Apakah Anda yakin?');">Hapus</a>
      </td>
    </tr>
  </c:forEach>
</tbody>
