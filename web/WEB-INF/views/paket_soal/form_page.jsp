...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Form Paket Soal <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->

	    <form name="form1" method="post" action="<%=Config.base_url%>index/PaketSoal/save">
	    <p id="aIntroductiona">
	      <label>
	      ...
	      <table width="50%" border="0">
            ...
            <tr>
              ...
              <td width="58%" valign="top"><label>
                ...
                <input name="idpaket_soal" type="hidden" id="idpaket_soal" value="${model.idpaket_soal}">
              </label></td>
            </tr>
            <tr>
          ...
          <p>Pilih Soal yang Akan dimasukkan ke dalam paket</p>
          <table width="100%" id="rounded-corner" summary="2007 Major IT Companies' Profit">
            <thead>
              <tr>
                ...
                <th width="20%" class="rounded-q1" scope="col">Bobot</th>
            ...
            <c:forEach items="${row_soal}" var="item" varStatus="status" >
                <tr>
                  <td><label>
					...
					<%
					   String checked="";
                                           ...
                                           String sql = "SELECT idpaket_soal_detail,bobot FROM paket_soal_detail where idpaket_soal = '" + session.getAttribute("idpaket_soal") + "' and idsoal='"+ soalModel.getIdsoal() +"'";
                  ...
                  <td>${item.domain}</td>
                  <td><label>
                    <input type="text"  id="bobot_soal_${item.idsoal}" name="bobot_soal_${item.idsoal}" 
                           <%
                              if(data.length>0) out.print("value=\""+data[0][1]+"\"");
                           %>
                           >
                  </label></td>
