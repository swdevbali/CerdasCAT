...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Form Wali Peserta Test <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
	    <h1></h1>
		
	    <table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E8EDFF">
          <tr>
            <td><form name="form2" method="post" action="<%=Config.base_url%>index/WaliPesertaTest/save">
                <table id="hor-zebra" summary="Employee Pay Sheet">
                  <thead>
                    <tr>
                      <th colspan="2" class="odd" scope="col">Form Input Wali Peserta Test </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr >
                    ...
                    <tr >
                      ...
                      <td><label>
                        ...
                        <select name="idpeserta_test" id="idpeserta_test">
						<option value="-1">-- Pilih Peserta Test --</option>
						<c:forEach items="${row_peserta_test}" var="item" varStatus="status">
                          <option value="${item.id}">${item.username}</option>
						 </c:forEach>
                        </select>
                      ${idpeserta_test_error}</label></td>
                    </tr>
                    <tr >
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
