...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Daftar Wali Peserta Test <!-- InstanceEndEditable --></h1>
          ...
          <tbody>
            <c:forEach items="${row}" var="item" varStatus="status" >
              <tr>
                ...
                <td>${item.username}</td>
                <td>${item.peran}</td>
                <td><a href="<%=Config.base_url%>index/WaliPesertaTest/input/${item.id}">Ubah</a> <a href="<%=Config.base_url%>index/WaliPesertaTest/delete/${item.id}"
