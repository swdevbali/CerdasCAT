...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Form Admin <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
	    <table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E8EDFF">
          <tr>
            <td><form name="form2" method="post" action="<%=Config.base_url%>index/admin/save">
                <table id="hor-zebra" summary="Employee Pay Sheet">
                  <thead>
                    <tr>
                      <th colspan="2" class="odd" scope="col">Form Admin </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr >
                    ...
                    <tr >
                      <td>Password</td>
                      <td><input name="password" type="password" id="password" value="${model.password}">
                        ${password_error}</td>
                    </tr>
                    <tr >
                      <td>&nbsp;</td>
