...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Daftar Admin <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
	    <h1></h1>
	    <a href="<%=Config.base_url%>index/Admin/input/-1">Tambah Data</a>
          ...
          <tbody>
            <c:forEach items="${row}" var="item" varStatus="status" >
              <tr>
                <td>${status.count}</td>
                <td>${item.username}</td>
                <td><a href="<%=Config.base_url%>index/Admin/input/${item.id}">Ubah</a> <a href="<%=Config.base_url%>index/admin/delete/${item.id}"
