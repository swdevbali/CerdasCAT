...
<tbody>
  <c:forEach items="${row}" var="item" varStatus="status" >
    <tr>
      ...
      <td>${item.peran}</td>
      <td>
         <a href="<%=Config.base_url%>index/Admin/input/${item.id}">Ubah</a>
         <a href="<%=Config.base_url%>index/Admin/delete/${item.id}" onClick="return confirm('Apakah Anda yakin?');">Hapus</a>
      </td>
    </tr>
  </c:forEach>
</tbody>
