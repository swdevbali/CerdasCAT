...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Daftar Peserta Test <!-- InstanceEndEditable --></h1>
		...
		<table width="100%" id="rounded-corner" summary="2007 Major IT Companies' Profit">
          <thead>
            <tr>
              ...
              <th scope="col" class="rounded-q1">Inisialisasi</th>
              <th scope="col" class="rounded-q1">Penyajian</th>
          ...
          <tbody>
            <c:forEach items="${row}" var="item" varStatus="status" >
              <tr>
                ...
                <td><a href="<%=Config.base_url%>index/PesertaTest/input/${item.id}">Ubah</a> <a href="<%=Config.base_url%>index/PesertaTest/delete/${item.id}"
