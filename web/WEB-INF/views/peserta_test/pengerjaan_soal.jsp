...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Pengerjaan Soal <!-- InstanceEndEditable --></h1>
...
<c:if test="${item!=null}">
 ...
 <div id="sisa" class="style2" align="center"></div>
	   <form name="form1" method="post" action="<%=Config.base_url%>index/AmbilUjian/jawabSoalDenganModel">
      <table width="80%" border="0">
          <tr>
            <td width="5%">No.</td>
            <td width="95%">Soal[${item.jawaban}- ${item.idskl}]</td>
          </tr>
		
          <tr>
            <td valign="top"></td>
            <td valign="top"><img src="<%=Config.base_url%>upload/${item.gambar}" alt="s" id="gambar"/>
              <input name="idsoal" type="hidden" id="idsoal" value="${item.idsoal}">
              <br>
        ...
        <label>
        <input name="btnJawab" type="submit" id="btnJawab" value="Jawab Soal">
        </label>
 </form>
 </c:if>
