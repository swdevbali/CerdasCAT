...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Pilih Domain Soal <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
            <c:forEach items="${row}" var="item" varStatus="status" >
              	
              <p align="center"><a href="<%=Config.base_url%>index/AmbilUjian/mulaiUjianDomain/${item.iddomain}">${item.domain}</a> </p>
            </c:forEach>
            <div align="center"><a href="<%=Config.base_url%>index/LihatHasilTest">Lihat Hasil Test</a>	        </div>
