...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Selamat datang <!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
		<h1></h1>
		<form action="<%=Config.base_url%>index/login/login" method="post">
          ...
          <tr>
            ...
            <td><label>
              <select name="peran" id="peran">
                ...
                <option value="Peserta Test">Peserta Test</option>
                <option value="Wali Peserta Test">Wali Peserta Test</option>
              </select>
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>${flash_error_message}</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label>
