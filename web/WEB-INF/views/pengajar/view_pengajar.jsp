...
<tbody>
  <c:forEach items="${row}" var="item" varStatus="status" >
    <tr>
      ...
      <td>${item.peran}</td>
      <td>
         <a href="<%=Config.base_url%>index/Pengajar/input/${item.id}">Ubah</a>
         <a href="<%=Config.base_url%>index/Pengajar/delete/${item.id}" onClick="return confirm('Apakah Anda yakin?');">Hapus</a>
      </td>
    </tr>
  </c:forEach>
</tbody>
