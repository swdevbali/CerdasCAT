...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Modul SKL <!-- InstanceEndEditable --></h1>
  ...
  <c:forEach items="${row}" var="item" varStatus="status" >
    <tr>
      ...
      <td>
         ...
         <a href="<%=Config.base_url%>index/Skl/delete/${item.idskl}" onClick="return confirm('Apakah Anda yakin?');">Hapus</a>      </td>
    </tr>
  </c:forEach>
</tbody>
</table>
