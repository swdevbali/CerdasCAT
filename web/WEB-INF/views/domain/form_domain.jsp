...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Judul Modul<!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
	    <h1></h1>
		
	    <table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E8EDFF">
          <tr>
            <td><form name="form2" method="post" action="<%=Config.base_url%>index/Domain/save">
                <table id="hor-zebra" summary="Employee Pay Sheet">
                  <thead>
                    <tr>
                      <th colspan="2" class="odd" scope="col">Form Domain </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr >
                      <td>Domain</td>
                      <td><label>
                        <input name="domain" type="text" id="domain" value="${model.domain}">
                        <input name="iddomain" type="hidden" id="iddomain" value="${model.iddomain}">
                      </label></td>
                    </tr>
