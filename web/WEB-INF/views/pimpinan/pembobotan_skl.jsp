...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Pembobotan SKL<!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
                    <form action="<%=Config.base_url%>index/pimpinan/save_pembobotan_skl" method="post">
                    <table width="370" border="1" align="center" cellpadding="0" cellspacing="0" id="hor-zebra" summary="Employee Pay Sheet">
                        <thead>
                            <tr>
                                <th colspan="3" class="odd" scope="col">Penetapan Pembobotan SKL <br/>${flash_message}</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr >
                                ...
                                <td bgcolor="#FFCCFF"><strong>
                                        <label><%=domain[idomain][1]%></label>
                                    </strong></td>
                                <td bgcolor="#FFCCFF"><strong>Bobot</strong></td>
                            </tr>
                            <%
                                String skl[][] = Db.getDataSet("select idskl,nama_skl from skl where iddomain=" + domain[idomain][0] + " order by nama_skl");
                            ...
                            <tr >
                                ...
                                <td>
                                    <%
                                        String bobot_skl[][] = Db.getDataSet("SELECT idpembobotan_skl,bobot FROM pembobotan_skl p where p.idskl=" + skl[iskl][0]);
                                        String sbobot_skl = "";
                                        if (bobot_skl.length == 0) {
                                            sbobot_skl = "0";
                                        } else {
                                            sbobot_skl = bobot_skl[0][1];
                                        }
                                    %>
                                    <label>
                                        <input name="skl_<%=skl[iskl][0]%>" type="text" value="<%=sbobot_skl%>"/>
                                    </label></td>
                                    <% }%>
                            </tr>
                            <% }%>
