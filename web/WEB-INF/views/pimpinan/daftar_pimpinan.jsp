...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    ...
	    <h1></h1>
	    <a href="<%=Config.base_url%>index/Pimpinan/input/-1">Tambah Data</a>
          ...
          <tbody>
            <c:forEach items="${row}" var="item" varStatus="status" >
              <tr>
                ...
                <td>${item.username}</td>
                <td>${item.peran}</td>
                <td><a href="<%=Config.base_url%>index/Pimpinan/input/${item.id}">Ubah</a> <a href="<%=Config.base_url%>index/Pimpinan/delete/${item.id}"
