...
<tbody>
  <c:forEach items="${row}" var="item" varStatus="status" >
    <tr>
      ...
      <td>${item.peran}</td>
      <td>
         <a href="<%=Config.base_url%>index/Pimpinan/input/${item.id}">Ubah</a>
         <a href="<%=Config.base_url%>index/Pimpinan/delete/${item.id}" onClick="return confirm('Apakah Anda yakin?');">Hapus</a>
      </td>
    </tr>
  </c:forEach>
</tbody>
