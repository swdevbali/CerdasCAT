...
<c:if test="${user_credential!=null}" >
	...
	<div id="pageContent">
	  ...
	  <div class="wikistyle">
	    <h1 id="Startinguptheproject"><!-- InstanceBeginEditable name="judul_modul" -->Pembobotan Kriteria Penilaian<!-- InstanceEndEditable --></h1>
	    <!-- InstanceBeginEditable name="isi_modul" -->
	     <form action="<%=Config.base_url%>index/pimpinan/save_pembobotan_kriteria" method="post">
        <table width="370" align="center" id="hor-zebra" summary="Employee Pay Sheet">
          <thead>
            <tr>
              <th colspan="3" class="odd" scope="col">Penetapan Pembobotan Kriteria <br>
              ${flash_message}</th>
            </tr>
          </thead>
          <tbody>
            ...
            <%
    	        String penilaian[][] = Db.getDataSet("select idpenilaian, nama_penilaian, bobot from penilaian order by idpenilaian");
            ...
            <tr >
              ...
              <td><%=penilaian[i][1]%> </td>
              <td><label>
                <input type="text" name="penilaian_<%=penilaian[i][0]%>" value="<%=penilaian[i][2]%>">
              </label></td>
            </tr>
            <%
				}
